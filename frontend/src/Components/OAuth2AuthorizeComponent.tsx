...
export function OAuth2AuthorizeComponent(
    props: OAuth2AuthorizeComponentProps
) {
            ...
            {props.newlyRequestedScopes && props.onAuthorizeDeny && (
                <div className={styles.scopeContainer}>
                    ...
                    <form
                        ...
                        method="POST"
                        action={`${APIBase.endpoint}/oauth2/authorize`}
                    >
                        ...
                        <div className={styles.buttonsContainer}>
                            <button
                                ...
                                className={classNames(
                                    buttonStyles.settingsButton,
                                    buttonStyles.positiveButton,
                                    buttonStyles.bigger
                                )}
                            >
                                Подключить
