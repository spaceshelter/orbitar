...
### Настройка IDE
Поставьте плагин для Prettier и включите автоматический запуск prettier при сохранении файлов. Опционально можно запускать `npm run prettier:fix` вручную.
