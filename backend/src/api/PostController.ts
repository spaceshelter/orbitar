...
export default class PostController {
  ...
  constructor(
    ...
    this.router.post('/post/create', this.postCreateRateLimiter, validate(postCreateSchema), (req, res) =>
      this.create(req, res),
    )
    this.router.post('/post/edit', this.postEditRateLimiter, validate(editSchema), (req, res) =>
      this.postEdit(req, res),
    )
    this.router.post('/post/comment', this.commentRateLimiter, validate(commentSchema), (req, res) =>
    ...
    this.router.post('/post/edit-comment', this.commentRateLimiter, validate(editCommentSchema), (req, res) =>
